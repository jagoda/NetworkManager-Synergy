...
class NetworkMatcherTest(unittest.TestCase):
	...
	config.set(host, network.NetworkMatcher.address, networks[0][0])
	config.set(host, network.NetworkMatcher.prefix, networks[0][1])
	config.set(host, network.NetworkMatcher.gateway, networks[0][2])
